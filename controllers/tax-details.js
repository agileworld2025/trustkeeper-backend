const TaxDetailService = require('../service/tax-details');
...
const save = async (req, res) => {
  try {
    ...
    const { doc, errors } = await TaxDetailService.save(data);
...
const getAll = async (req, res) => {
  try {
    ...
    const { doc, errors } = await TaxDetailService.getAll(data);
...
const update = async (req, res) => {
  try {
    ...
    const { doc, errors } = await TaxDetailService.update({ publicId, userId, ...body });
...
const deleted = async (req, res) => {
  try {
    ...
    const { doc, errors } = await TaxDetailService.deleted({ publicId, userId });
