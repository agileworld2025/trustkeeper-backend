...
const { patch: patchSchema, save: saveSchema } = require('../dto-schemas/social-media/index');
...
const save = async (req, res) => {
  try {
    ...
    const { doc, errors } = await SocialMediaService.save(validatedData);
...
const update = async (req, res) => {
  try {
    ...
    const { doc, errors } = await SocialMediaService.patch(validatedData);
